        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div
              ...
              style={{ opacity: 0 }}
            >
              <button className="flex items-center gap-2 px-6 py-3 bg-[var(--neon)] text-[hsl(220,30%,6%)] rounded-xl font-bold text-sm hover:bg-[rgba(0,212,255,0.85)] transition-all duration-200 shadow-[var(--neon-glow)] hover:shadow-[var(--neon-strong)]">
                Начать мониторинг
              </button>
              <button className="flex items-center gap-2 px-6 py-3 border border-[rgba(0,212,255,0.3)] text-[var(--neon)] rounded-xl font-medium text-sm hover:bg-[rgba(0,212,255,0.08)] transition-all duration-200">
                Демонстрация
              </button>
            </div>
